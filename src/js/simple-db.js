// Sistema de Banco Simples para Produção
class SimpleDB {
    constructor() {
    ...
    init() {
        // Garantir que há dados iniciais
    ...
    updateProduct(id, productData) {
        ...
        if (index !== -1) {
            ...
            console.log(`✅ Produto ${id} atualizado:`, productData);
            return true;
        }
        return false;
    }
...
// Substituir DataManager por versão simples
window.dataManager = {
    db: new SimpleDB(),
    ...
    async updateProduct(id, productData) {
        return this.db.updateProduct(id, productData);
    },
    
    async addProduct(productData) {
        return this.db.addProduct(productData);
    },
...
console.log('✅ Sistema de banco simples carregado');